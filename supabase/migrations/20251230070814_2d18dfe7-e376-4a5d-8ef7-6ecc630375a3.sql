-- Enable pgcrypto so crypt() works for password verification
CREATE EXTENSION IF NOT EXISTS pgcrypto;

-- Recreate verify_admin_login to ensure it uses pgcrypto's crypt()
...
-- Ensure assign_admin_role works with admin record present
